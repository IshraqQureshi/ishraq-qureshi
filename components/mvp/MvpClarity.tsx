    ...
    <section className="py-14 md:py-16">
      <Container className="grid gap-6 md:grid-cols-2">
        <div className="flex flex-col gap-4 rounded-2xl border border-border-subtle bg-surface/40 p-6">
          ...
          <p className="text-sm leading-relaxed text-foreground-muted">{mvpValidated.paragraph}</p>
          <p className="text-sm font-medium leading-relaxed text-foreground">{mvpValidated.note}</p>
        </div>
